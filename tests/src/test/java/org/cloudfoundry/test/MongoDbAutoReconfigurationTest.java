...
@Ignore
public final class MongoDbAutoReconfigurationTest extends AbstractTest<Tuple2<String, String>> {

    @Autowired
    private RedisService service;

    public MongoDbAutoReconfigurationTest() {
        super("mongodb");
    }
    ...
    protected void test(Application application, TestSubscriber<Tuple2<String, String>> testSubscriber) {
        Mono
            .when(application.request("/mongodb/check-access"), application.request("/mongodb/url"))
