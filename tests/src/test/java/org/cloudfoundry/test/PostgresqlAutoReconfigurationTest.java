...
@Ignore
public final class PostgresqlAutoReconfigurationTest extends AbstractTest<Tuple2<String, String>> {

    @Autowired
    private RedisService service;

    public PostgresqlAutoReconfigurationTest() {
        super("postgresql");
    }
    ...
    protected void test(Application application, TestSubscriber<Tuple2<String, String>> testSubscriber) {
        Mono
            .when(application.request("/postgresql/check-access"), application.request("/postgresql/url"))
